...
```
The optimized running job script for 2 nodes is [job_QE_2x48]([Example_04/job_QE_2x48](https://github.com/Dmitry-Skachkov/Yambo_examples/blob/main/Example_04/job_QE_2x48))    
